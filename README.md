...
Review: It shows how many spam comments were detected
...
Keep your client_secret.json safe
Regularly update the BLACKLIST in filter.py for new spam patterns
Run ARCNET periodically for new comments
Contributing
Fork the repo
Make your changes
